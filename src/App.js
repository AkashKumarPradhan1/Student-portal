...
function App() {
  ...
  const totalFeesCollected = students.reduce(
    (sum, student) =>
      sum + Number(student.Fees_Paid || 0),
    0
  );

  const totalPendingFees = students.reduce(
    (sum, student) =>
      sum + Number(student.Fees_Pending || 0),
    0
  );
  ...
  students.forEach((student) => {
    ...
    const edu = student.Education || "Others";

    educationCount[edu] =
      (educationCount[edu] || 0) + 1;
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="stats-container">
        ...
        <div className="stat-card">
          <h2>₹{totalFeesCollected}</h2>
          <p>Fees Collected</p>
        </div>

        <div className="stat-card">
          <h2>₹{totalPendingFees}</h2>
          <p>Pending Fees</p>
        </div>
      ...
      <div className="dual-section">
        ...
        <div className="card section-card">
          ...
          <input
            type="text"
            placeholder="Search ID, Name, Education, Marks..."
            value={studentSearch}
            onChange={(e) =>
        ...
        <div className="card section-card">
          ...
          <input
            type="text"
            placeholder="Search ID, Name, Total Fees, Paid, Pending..."
            value={feeSearch}
            onChange={(e) =>
